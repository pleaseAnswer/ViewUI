<template>
    ...
    >
            ...
            <Drop
                ...
                <div>
                    <component
                        ...
                        :endDateSetMaxTime="endDateSetMaxTime"
                        :shortcutUnique="shortcutUnique"
        ...
        <i-dropdown trigger="custom" :placement="placement"
            v-if="shortcutUnique&&shortcutMenu.length" 
            :class="[prefixCls + '-shortcut-menu']"
            :visible="shortcutMenuDropdown"

            @on-visible-change="shortcutContainerClickHandler"
            @on-clickoutside="shortcutMenuClose"
        >
            ...
            <i-dropdown-menu slot="list">
                <li v-for="(item, index) of shortcutMenu" :key="index" :name="index" 
                    :class="[prefixCls + '-shortcut-item', {[prefixCls + '-shortcut-item-g1']: item.grid === 1}]"
                    @click="shortcutClickHandler(item)"
                >{{ item.text }}</li>
            </i-dropdown-menu>
        </i-dropdown>
    </div>
...
<script>
    ...
    import iDropdownMenu from '../dropdown/dropdown-menu.vue';
    ...
    import shortcutMenu from './picker/shortcut-time-mixin';
    ...
    export default {
        mixins: [ Emitter, shortcutMenu ],
        components: { iInput, Drop, Icon, iDropdown, iDropdownMenu },
        ...
        computed: {
            wrapperClasses(){
                return [prefixCls, {
                    ...
                    [prefixCls + '-shortcut-dropdown']: this.shortcutUnique && this.shortcutMenu.length
                }];
            },
            publicVModelValue(){
                if (this.multiple){
